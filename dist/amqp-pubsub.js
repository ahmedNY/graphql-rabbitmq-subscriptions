...
var AmqpPubSub = (function () {
    function AmqpPubSub(options) {
        ...
        if (options.useQueues) {
            this.consumer = new rabbitmq_pub_sub_1.RabbitMqConsumer(logger, factory);
            this.producer = new rabbitmq_pub_sub_1.RabbitMqProducer(logger, factory);
        }
        else {
        ...
        if (refs && refs.length > 0) {
            ...
            return new Promise(function (resolve, reject) {
                ...
                _this.consumer.subscribe(triggerName, function (msg) { return _this.onMessage(triggerName, msg); })
                    ...
                    _this.unsubscriptionMap[id] = disposer;
                    return resolve(id);
                }).catch(function (err) {
    ...
    AmqpPubSub.prototype.unsubscribe = function (subId) {
        ...
        if (refs.length === 1) {
            newRefs = [];
            this.unsubscriptionMap[subId]().then(function () {
